...
'head'.  By pressing the 'Expand' button below the SteamVR LogErroro in SteamVR_Camera's Inspector, these objects are
...
SteamVR_Camera is itself used to render each eye.  And finally, the button below the SteamVR LogErroro will change to
