...
namespace UnityStandardAssets.ImageEffects
{
    ...
    public class PostEffectsBase : MonoBehaviour
	{
		...
		{
            Debug.LogError("The shader " + s.ToString () + " on effect "+ ToString () + " is not part of the Unity 3.2+ effects suite anymore. For best performance and quality, please ensure you are using the latest Standard Assets Image Effects (Pro only) package.");
            if (!s.isSupported)
			{
                NotSupported ();
                return false;
